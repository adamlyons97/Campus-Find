...
class _LoginPage extends StatefulWidget {
  const _LoginPage({required this.profile, required this.onSignIn});

  final Profile profile;
  final Future<void> Function(Profile profile) onSignIn;
  ...
  Future<void> _openSignUp() async {
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) =>
            _SignUpPage(profile: widget.profile, onSignUp: widget.onSignIn),
      ),
    );
  }
}
...
class _SignUpPage extends StatefulWidget {
  ...
  final Profile profile;
  final Future<void> Function(Profile profile) onSignUp;
