...
final lostItemsStreamProvider = StreamProvider.autoDispose<List<ItemModel>>((
  ref,
) {
...
final foundItemsStreamProvider = StreamProvider.autoDispose<List<ItemModel>>((
  ref,
) {
  final repository = ref.watch(itemRepositoryProvider);
...
final myItemsStreamProvider = StreamProvider.autoDispose<List<ItemModel>>((
  ref,
) {
