...
final specificItemProvider = FutureProvider.family<ItemModel?, String>((
  ref,
  itemId,
) async {
                            ...
                            return profileState.when(
                              ...
                              data: (userData) {
                                ...
                                if (name.isEmpty || name.contains('@')) {
                                  name =
                                      'Ahmad Adam Danial Bin Ab Rahman'; // Safe fallback for old test items
                                }
